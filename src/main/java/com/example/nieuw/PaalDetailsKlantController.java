...
public class PaalDetailsKlantController {
    ...
    public void setPaalnummer(String paalnummer) {
        ...
        updateGebruiksfrequentie(); // Zorg ervoor dat gebruiksfrequentie correct geladen wordt
    }
    ...
    // Methode om terug te navigeren naar zoekpaginaKlant.fxml
    @FXML
    private void switchToZoekpagina(javafx.scene.input.MouseEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/nieuw/zoekpaginaKlant.fxml"));
